<div class="container">
    ...
    <div class="row">
        <div class="col">
            ...
            <p>Per accedere al sistema può cliccare sul bottone riportato qui di seguito.</p>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col">
            <p>In alternativa è possibile raggiungere il sito tramite il seguente link <a href="http://italian-psq.herokuapp.com/">http://italian-psq.herokuapp.com/</a></p>
